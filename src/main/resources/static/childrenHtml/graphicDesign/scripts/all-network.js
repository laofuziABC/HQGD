...
App = {
    ...
    initEditor: function() {
        var xml = "<?xml version='1.0' encoding='UTF-8'?>"
            + "<process name='untitled' xmlns='http://jbpm.org/4.4/jpdl'>"
			  + "<Cloud g='564,112,128,128' name='Cloud 1'/>"
			  + "<Cloud g='581,272,128,128' name='Cloud 2'/>"
			  + "<Firewall g='506,161.5,62,206.5' name='Firewall 1'>"
				+ "<transition to='Coreswitcher 1'/>"
			  + "</Firewall>"
			  + "<rect rounded='0' g='748,79,251,147' name='rect 1'/>"
			  + "<House2 g='775.5,101.5,73.5,64.5' name='House2 1'>"
				+ "<transition to='Cloud 1'/>"
			  + "</House2>"
			  + "<House2 g='827.5,133.5,76.5,61.5' name='House2 2'>"
				+ "<transition to='Cloud 1'/>"
			  + "</House2>"
			  + "<Pc g='904.5,144.5,79,71' name='Pc 1'>"
				+ "<transition to='Cloud 1'/>"
			  + "</Pc>"
			  + "<rect rounded='0' g='752,268,249,155' name='rect 3'/>"
			  + "<Networkserver g='787,277,60,83' name='Networkserver 1'/>"
			  + "<Webserver g='871,280,53,79' name='Webserver 1'/>"
			  + "<Webserver g='835,345,63,79' name='Webserver 2'/>"
			  + "<ellipse g='813,320,80,60' name='ellipse 1'>"
				+ "<transition to='Cloud 2'/>"
			  + "</ellipse>"
			  + "<Coreswitcher g='187,189.5,120,68.5' name='Coreswitcher 1'>"
				+ "<transition to='Firewall 1'/>"
				+ "<transition name='to Software 2' to='Software 2'/>"
				+ "<transition name='to Software 3' to='Software 3'/>"
				+ "<transition name='to Software 1' to='Software 1'/>"
				+ "<transition name='to A10700 1' g='246,303;124,301:-46,27' to='A10700 1'/>"
				+ "<transition name='to A10700 2' g='6,31' to='A10700 2'/>"
				+ "<transition name='to Cluster 1' g='247,303;436,303:66,38' to='Cluster 1'/>"
			  + "</Coreswitcher>"
			  + "<A10700 g='84.5,359,77,52' name='A10700 1'/>"
			  + "<A10700 g='210.5,355,77,52' name='A10700 2'/>"
			  + "<Cluster g='353,347,172,100' name='Cluster 1'/>"
			  + "<Software g='93.5,50,91,86' name='Software 1'/>"
			  + "<Software g='206.5,44,91,86' name='Software 2'/>"
			  + "<Software g='331.5,46,91,86' name='Software 3'/>"
...
var tpls = [
['A10700','A10700', 'images/stenciles/network/10700.jpg', 77, 52],
['Antenna','Antenna', 'images/stenciles/network/antenna.jpg', 88, 102],
['AXP','AXP', 'images/stenciles/network/AXP.jpg', 77, 74],
['Bbfw','Bbfw', 'images/stenciles/network/bbfw.jpg', 20, 16],
['Cloud','Cloud', 'images/stenciles/network/cloud1.png', 128, 128],
['Cluster','Cluster', 'images/stenciles/network/cluster.jpg', 172,100 ],
['Communicator','Communicator', 'images/stenciles/network/communicator.jpg', 134, 74],

['Coreswitcher','Coreswitcher', 'images/stenciles/network/core_switcher.png', 148, 95],

['Dish','Dish', 'images/stenciles/network/dish.jpg', 98, 72],
['Fax','Fax', 'images/stenciles/network/fax.jpg', 126, 60],
['Firewall','Firewall', 'images/stenciles/network/firewall.png', 62, 147],
['Gatekeeper','Gatekeeper', 'images/stenciles/network/gatekeeper.jpg', 79,57 ],
['Hootphone','Hootphone', 'images/stenciles/network/hootphone.jpg', 64, 48],

['House1','House1', 'images/stenciles/network/house1.png', 157, 117],
['House2','House2', 'images/stenciles/network/house2.png', 173, 115],
['Hpprinter','Hpprinter', 'images/stenciles/network/hp_printer.png', 128,128 ],
['Ibm','Ibm', 'images/stenciles/network/ibm.png', 212,142 ],
['Mycomputer2','Mycomputer2', 'images/stenciles/network/my_computer2.png', 128,128 ],
['Network2','Network2', 'images/stenciles/network/network_2.png',128 ,128 ],
['Networkserver','Networkserver', 'images/stenciles/network/network_server.png',128 ,128 ],

['Pc','Pc', 'images/stenciles/network/pc.jpg',79 ,71 ],
['Phone','Phone', 'images/stenciles/network/phone.jpg',33 ,57 ],

['Modem','Modem', 'images/stenciles/network/modem.png', 128,128 ],

['Sattelite','Sattelite', 'images/stenciles/network/sattelite.jpg',133 ,45 ],
['Software','Software', 'images/stenciles/network/software.jpg',91 ,86 ],
['Streamer','Streamer', 'images/stenciles/network/streamer.jpg', 407, 223],
['Terminal','Terminal', 'images/stenciles/network/terminal.jpg', 98, 119],


['User', 'User', 'images/stenciles/network/user.png',128 ,128 ],
['Webserver','Webserver', 'images/stenciles/network/web_server.png', 128, 128],
['Wirelesstower2','Wirelesstower2', 'images/stenciles/network/wireless_tower_2.png', 128, 128]
];
...
function makePaletteArray2(arr){
    var ret = [];
	for(var i=0;i<tpls.length;i++){
...
App.PalettePanel = Ext.extend(Ext.Panel, {
    ...
    createItemsForAccordion: function() {
        ...
        this.items = [{
            ...
            iconCls: 'tb-activity',
            autoScroll: true,
            html: this.createHtml(makePaletteArray1(tpls))
        }, {
            title: '高级图元',
            iconCls: 'tb-activity',
            autoScroll: true,
            html: this.createHtml(makePaletteArray2(tpls))
        }];
    },
