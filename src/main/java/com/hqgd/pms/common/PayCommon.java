...
* 描述：静态公共方法
* 作者：姚绒
* 日期：2018年11月19日 下午3:22:03
*
*/
public class PayCommon {
	
	/**
	* 描述：将字符型的枚举值转换为对应的枚举类值
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:21:46
	* @param enumType
	* @param nameStr
	* @return    
	* T   
	...
	*/
	...
	/**
	* 描述：获取一个key按升序排列的TreeMap<String,String>
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:21:33
	* @return    
	...
	*/
	...
	/**
	* 描述：获取一个key按指定顺序排列的TreeMap<String,String>
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:21:17
	* @param flag
	* @return    
	* TreeMap<String,String>   
	* @throws
	*/
	...
	/**
	* 描述：获取一个按key升序排列的TreeMap<K,V>
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:21:00
	* @return    
	* TreeMap<K,V>   
	* @throws
	*/
	...
	*/
	...
	/**
	* 描述：根据设置的时间格式获取当前服务器时间
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:20:23
	* @param formatString
	* @return    
	* String   
	* @throws
	*/
	...
	/**
	* 描述：根据设置的时间格式转换Date对象
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:20:10
	* @param formatString
	* @param date
	* @return    
	* String   
	...
	*/
	...
	/**
	* 描述：获取当前服务器时间(时间格式：yyyy-MM-dd)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:19:57
	* @return    
	* String   
	* @throws
	*/
	...
	/**
	* 描述：获取当前服务器时间(时间格式：yyyy-MM-dd HH:mm:ss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:19:45
	* @return    
	* String   
	* @throws
	*/
	...
	/**
	* 描述：将Date转化为字符串的时间格式(yyyy-MM-dd HH:mm:ss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:19:33
	* @param date
	* @return    
	* String   
	* @throws
	*/
	...
	/**
	* 描述：将字符串的时间格式转化为Date(yyyy-MM-dd HH:mm:ss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:19:03
	* @param simpleFormatTimestamp
	* @return
	* @throws ParseException    
	* Date   
	* @throws
	*/
	public static Date getDateBySimpleFormatTimestamp(
			String simpleFormatTimestamp) throws ParseException {
		if (simpleFormatTimestamp.isEmpty()
				|| simpleFormatTimestamp.length() < 10) {
			return null;
		}
		SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	/**
	* 描述：将字符串的时间格式转化为Date(yyyyMMddHHmmss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:18:51
	* @param noFormatTimestamp
	* @return
	* @throws ParseException    
	* Date   
	* @throws
	*/
	public static Date getDateByNoFormatTimestamp(String noFormatTimestamp)
			throws ParseException {
		if (noFormatTimestamp.isEmpty()
				|| noFormatTimestamp.length() < 10) {
			return null;
		}
	...
	/**
	* 描述：将字符串的时间formatTimestamp格式转化为Date
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:18:39
	...
	* @throws
	*/
	public static Date getDateByFormatTimestamp(String formatTimestamp,
	...
	/**
	* 描述：获取当前服务器时间(时间格式：yyyyMMddHHmmss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:18:26
	* @return    
	* String   
	* @throws
	*/
	...
	/**
	* 描述：将Date转化为字符串的时间格式(时间格式：yyyyMMddHHmmss)
	* 作者：姚绒
	* 日期：2018年11月19日 下午3:18:12
	* @param date
	* @return    
	* String   
	* @throws
